...
namespace backend.Migrations
{
    ...
    [Migration("20260716174301_AddSupplierIdToProductAuditLog")]
    partial class AddSupplierIdToProductAuditLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.Inventory.ProductAuditLog", b =>
                {
            ...
            modelBuilder.Entity("backend.Models.InvoiceModel.Invoice", b =>
                {
                    ...
                    b.Property<int?>("AutoReplenish_Restock_ID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AutoReplenish_Restock_ID");
            ...
            modelBuilder.Entity("backend.Models.RestockModel.Restock", b =>
                {
                    ...
                    b.Property<string>("Delivery_Resolution")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("Restock_Invoice_Reference")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("backend.Models.Inventory.ProductAuditLog", b =>
                {
                    ...
                    b.HasOne("backend.Models.Unit.Product_Unit_Preset", "ProductPreset")
                        .WithMany()
                        .HasForeignKey("Product_Preset_ID");

                    b.Navigation("Product");

                    b.Navigation("ProductPreset");
                });

            modelBuilder.Entity("backend.Models.InvoiceModel.Invoice", b =>
                {
                    b.HasOne("backend.Models.RestockModel.Restock", "AutoReplenishRestock")
                        .WithMany()
                        .HasForeignKey("AutoReplenish_Restock_ID")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("AutoReplenishRestock");
